...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .app{display:grid;grid-template-columns:260px 1fr;height:100vh;overflow:hidden;position:fixed;inset:0;z-index:1}
    ...
    .nav a:hover, .nav button:hover{background:rgba(255,255,255,.08);color:var(--text);transform:none;}
    ...
    .dashboard{display:grid;grid-template-columns:minmax(0,1.2fr) minmax(0,0.8fr);gap:12px;align-items:stretch;min-width:0}
    .dash-left{display:flex;flex-direction:column;gap:12px;min-width:0;overflow:hidden}
    .dash-right{display:flex;flex-direction:column;gap:12px;min-width:0;overflow:hidden}
