...
@section('subheader', 'Update an attendance record.')
...
<div class="g-6-4">
    <div class="card">
        ...
        <div style="display:grid;gap:10px;">
            ...
            <div>
                ...
                <div class="fi">{{ $record->classe->name ?? 'N/A' }} ({{ $record->classe->code ?? '-' }})</div>
            </div>
            <div>
    ...
    <div class="card">
        ...
        <form method="POST" action="{{ route('admin.attendance-records.update', $record) }}" style="display:grid;gap:10px;">
            @csrf
            @method('PUT')
            ...
            <div style="display:flex;gap:8px;flex-wrap:wrap;justify-content:flex-end;">
                <a href="{{ route('admin.attendance-records', ['class' => $record->class_id]) }}" class="btn">Cancel</a>
