...
@section('content')
<div style="min-height:calc(100vh - 160px);display:grid;place-items:center;padding:32px 18px;">
    <div style="width:100%;max-width:1080px;display:grid;gap:22px;">
        ...
        <div class="card glass" style="padding:24px;">
            ...
            <form method="POST" action="{{ route('professor.attendance-records.update', $record) }}" style="display:grid;gap:14px;">
                @csrf
                @method('PUT')
