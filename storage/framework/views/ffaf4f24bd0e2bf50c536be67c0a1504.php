<?php $__env->startSection('title', 'Users Management - Admin'); ?>
<?php $__env->startSection('header', 'Users Management'); ?>
                ...
                <tbody class="divide-y divide-gray-800">
                    <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-800/50 transition">
                            <td class="px-6 py-4 text-white"><?php echo e($user->name); ?></td>
                            <td class="px-6 py-4 text-gray-400"><?php echo e($user->email); ?></td>
                            <td class="px-6 py-4 text-gray-400"><?php echo e($user->username); ?></td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <span class="inline-block px-3 py-1 <?php echo e($user->is_active ? 'bg-green-900/30 text-green-300' : 'bg-red-900/30 text-red-300'); ?> text-xs rounded-full font-semibold">
                                    <?php echo e($user->is_active ? 'Active' : 'Inactive'); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 flex gap-2">
                                <a href="<?php echo e(route('admin.users.edit', $user)); ?>" class="text-blue-400 hover:text-blue-300 font-semibold text-sm">Edit</a>
                                <form action="<?php echo e(route('admin.users.delete', $user)); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure?')">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\qr_attendace-system\resources\views/admin/users.blade.php ENDPATH**/ ?>