...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Full-screen layout: remove simulated browser chrome */
        .browser {
            width: 100%;
            max-width: none;
            margin: 0;
        ...
        /* hide the faux browser bar (URL + dots) for a native full-screen app feel */
        .browser-bar {
            display: none;
        }
        ...
        .sb-avatar{width:30px;height:30px;border-radius:50%;background:linear-gradient(135deg,#e17055,#d63031);display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:700;flex-shrink:0;}
        ...
        @media (max-width: 840px) {
            ...
            .sb { display: none; }
            .browser { margin: 0; border-radius: 0; max-width: none; border-left: none; border-right: none; }
        }
    </style>
</head>
<body>
<div class="browser">
    <div class="browser-bar">
        ...
        <div class="urlbar"><?php echo e(request()->getHost()); ?><?php echo e(request()->getRequestUri()); ?></div>
    </div>
    ...
    <div class="shell">
        <aside class="sb">
            ...
            <div class="sb-user">
                <div class="sb-avatar"><?php echo e(strtoupper(substr(auth()->user()->name ?? 'AD', 0, 1))); ?></div>
                <div>
                    <div class="sb-uname"><?php echo e(auth()->user()->name); ?></div>
                    <div class="sb-urole"><span class="sb-online"></span>System Administrator</div>
                </div>
            </div>

            <div class="sb-sec">Management</div>
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="sb-item <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">Dashboard</a>
            <a href="<?php echo e(route('admin.users')); ?>" class="sb-item <?php echo e(request()->routeIs('admin.users*') ? 'active' : ''); ?>">Users</a>
            <a href="<?php echo e(route('admin.professors')); ?>" class="sb-item <?php echo e(request()->routeIs('admin.professors') ? 'active' : ''); ?>">Professors</a>
            <a href="<?php echo e(route('admin.students')); ?>" class="sb-item <?php echo e(request()->routeIs('admin.students') ? 'active' : ''); ?>">Students</a>
            <a href="<?php echo e(route('admin.classes')); ?>" class="sb-item <?php echo e(request()->routeIs('admin.classes*') ? 'active' : ''); ?>">Classes</a>
            <a href="<?php echo e(route('admin.qr-codes')); ?>" class="sb-item <?php echo e(request()->routeIs('admin.qr-codes*') ? 'active' : ''); ?>">QR Code Mgmt</a>
            <a href="<?php echo e(route('admin.attendance-records')); ?>" class="sb-item <?php echo e(request()->routeIs('admin.attendance-records') ? 'active' : ''); ?>">Attendance Records</a>
            <a href="<?php echo e(route('admin.reports')); ?>" class="sb-item <?php echo e(request()->routeIs('admin.reports') ? 'active' : ''); ?>">Reports</a>
            <a href="<?php echo e(route('admin.logs')); ?>" class="sb-item <?php echo e(request()->routeIs('admin.logs') ? 'active' : ''); ?>">System Logs</a>
        ...
        <div class="page-wrap">
            <div class="topbar">
                <div>
                    <div class="topbar-title"><?php echo $__env->yieldContent('header', 'Admin'); ?></div>
                    <div class="topbar-sub"><?php echo $__env->yieldContent('subheader', 'Manage the QR attendance system.'); ?></div>
                </div>
                <div class="topbar-right">
                    <div class="topbar-date" id="current-date"></div>
                    <div class="topbar-clock" id="current-time"></div>
                    <div class="notif-btn" aria-hidden="true">
                        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9"/></svg>
...
<?php /**PATH C:\xampp\htdocs\dashboard\Attendance-System\resources\views/layouts/admin.blade.php ENDPATH**/ ?>